# Django settings for fyl_try2 project.
import os
...
SECRET_KEY = 'st52jwt_mcbd3-(=3z1&amp;h%k*23_u!b!+0iy)!+5^)50+$pcv&amp;t'
...
ROOT_URLCONF = 'fyl_try2.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fyl_try2.wsgi.application'
